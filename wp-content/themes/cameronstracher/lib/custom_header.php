...
function ww_custom_header()
{
 ...
 $coverimage = get_the_post_thumbnail( get_post_meta(get_the_ID(), 'full', array( 'class' => '' ) ));
 $parentID = wp_get_post_parent_id( get_the_ID());
 $page_object = get_page( get_the_ID());

 $pos = strpos($page_object->post_content, ' ');
 // echo $pos . 'svsdv: ' . strlen($page_object->post_content);
 if($parentID  == 70){
...
// 			</nav>
 ...
 echo '<header class="site-header" role="banner" itemscope="itemscope" itemtype="http://schema.org/WPHeader">
   <div class="wrap">
     ...
     if(is_home() || is_front_page() || $parentID != '70') {
     ...
     if(is_home() || is_front_page()) {
       echo '<div class="books"><a href="/staging/5308/books/the-curve/"><img src="/wp-content/themes/cameronstracher/images/book_curve.png" alt=""></a><a href="/staging/5308/books/kings-of-the-road/"><img src="/wp-content/themes/cameronstracher/images/book_kings.png" alt=""></a><a href="/staging/5308/books/the-water-wars/"><img src="/wp-content/themes/cameronstracher/images/book_water.png" alt=""></a><a href="/staging/5308/books/dinner-with-dad/"><img src="/wp-content/themes/cameronstracher/images/book_dinner.png" alt=""></a><a href="/staging/5308/books/double-billing/"><img src="/wp-content/themes/cameronstracher/images/book_double.png" alt=""></a><a href="/staging/5308/books/the-laws-of-return/"><img src="/wp-content/themes/cameronstracher/images/book_return.png" alt=""></a></div>
     ...
     echo '<div class="book-header-content">'.$coverimage.'<h1>'.get_the_title().'</h1><p>'.$text.' ...</p></div><div class="header-vendors">
       <a href="#"><img src="/wp-content/themes/cameronstracher/images/amazon_logo_blue.svg" alt="Cameron Stracher" style="width: 13%;"></a><a href="#"><img src="/wp-content/themes/cameronstracher/images/bn_logo_blue.svg" alt="Cameron Stracher" style="width: 13%; padding-bottom: .5em;"></a><a href="#"><img src="/wp-content/themes/cameronstracher/images/indie_logo_blue.png" alt="Cameron Stracher"></a><a href="#"><img src="/wp-content/themes/cameronstracher/images/bam_logo_blue.png" alt="Cameron Stracher"></a><a href="#"><img src="/wp-content/themes/cameronstracher/images/powells_logo_blue.png" alt="Cameron Stracher"></a><a href="#"><img src="/wp-content/themes/cameronstracher/images/kobo_logo_blue.svg" alt="Cameron Stracher"></a>
     </div>';
     getPrevNext();
   }
...
echo '</div>
 ...
 $pagelist = get_pages('sort_column=menu_order&child_of=70');
 $pages = array();
